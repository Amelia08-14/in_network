...
async function main() {
  ...
  // Espaces, formules, catalogue de services et modèles de devis : voir
  // prisma/catalogue.ts (source unique, partagée avec `npm run catalogue:sync`).
  await syncCatalogue(prisma, { siteId: site.id });
